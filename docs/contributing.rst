...
you need to install `aleth <https://github.com/ethereum/aleth/releases/download/v1.5.0-alpha.minefix/aleth-1.5.0-alpha.6+commit.5e06a78f-linux-x86_64.tar.gz>`_ and run it in testing mode: ``aleth --test -d /tmp/testeth`` (make sure to rename it).
...
.. note ::
    ...
    Currently the CI uses ``5e06a78f18c92f261df79ddc56ca5711f9b17747`` of ``aleth``.
